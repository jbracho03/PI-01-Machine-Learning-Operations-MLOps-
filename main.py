...
def get_score_count(platform: str, score: float, year: int):
    if platform in ['netflix', 'disney', 'hulu', 'amazon'] and isinstance(score, float) and isinstance(year, int):
        # Selecciona sólo las filas donde el id comience con la plataforma, score y ano sea el especificado
        ...
        return {"platform": platform_name, "ScoreMedia >": score, "year": year, "count": count}
    else:
